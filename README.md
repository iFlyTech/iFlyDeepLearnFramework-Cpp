...
The file tests/main.cpp contains an example of a neural network's implementation utilizing the developed library. It demonstrates classification of 2D data points into 2 classe